        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>First Odd</TableCell>
              <TableCell>Second Odd</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {console.log("truuu:  ",trueResults)}
              ...
              return (
                <React.Fragment key={index}>
                  <TrueResultRow>
                    ...
                    <TableCell>{trueResult.type}</TableCell>
                    <TableCell>{trueResult.firstOdd}</TableCell>
                    <TableCell>{trueResult.secondOdd}</TableCell>
                  </TrueResultRow>
                  <StyledTableRow mismatch={mismatch}>
                    ...
                    <TableCell>{otherResult ? otherResult.type : ''}</TableCell>
                    <TableCell>{otherResult ? otherResult.firstOdd : ''}</TableCell>
                    <TableCell>{otherResult ? otherResult.secondOdd : ''}</TableCell>
                  </StyledTableRow>
                </React.Fragment>
              );
            })}
